...
public class EcBottomDelegate extends BaseBottomDelegate {
    ...
    public LinkedHashMap<BottomTabBean, BottomItemDelegate> setItems(ItemBuilder builder) {
        ...
        items.put(new BottomTabBean("{fa-sort}", "智慧安监"), new IndexDelegate());
        items.put(new BottomTabBean("{fa-compass}", "待办任务"), new TaskDelegate());
...
//        items.put(new BottomTabBean("{fa-shopping-cart}", "统计报表"), new IndexDelegate());
        items.put(new BottomTabBean("{fa-user}", "设置"), new SettingDelegate());
