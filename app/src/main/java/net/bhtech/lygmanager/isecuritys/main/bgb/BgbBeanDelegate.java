...
public class BgbBeanDelegate extends BottomItemDelegate {
    ...
    public void openFullView(View view)
    {
        if(BGB_NO.getEditTextInfo()!=null&&!"".equals(BGB_NO.getEditTextInfo()))
        {
            if(!"".equals(PICTUREA.getEditTextInfo())) {
                FullimageDelegate delegate = FullimageDelegate.create("BGB_PICTUREA_" + BGB_NO.getEditTextInfo(),"RMBGBMST",BGB_NO.getEditTextInfo());
    ...
    public static BgbBeanDelegate create(String pictures) {
        final Bundle args = new Bundle();
        args.putString("BGB_NO", pictures);
        final BgbBeanDelegate delegate = new BgbBeanDelegate();
