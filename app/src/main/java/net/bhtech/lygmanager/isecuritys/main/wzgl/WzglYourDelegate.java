...
import net.bhtech.lygmanager.isecuritys.main.bgb.BgbClickListener;
import net.bhtech.lygmanager.isecuritys.main.bgb.BgbDataConverter;
...
public class WzglYourDelegate extends BottomItemDelegate {
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, @NonNull View rootView) {
        ...
        button_forward.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WzglBeanDelegate delegate = WzglBeanDelegate.create("-1");
    ...
    public void onSupportVisible() {
        mRefreshHandler.getWzglList( getContext(),"YOUR");
    }
