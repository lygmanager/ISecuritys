package net.bhtech.lygmanager.net.cxfweservice.ksoap2.transport;


import net.bhtech.lygmanager.net.cxfweservice.ksoap2.HeaderProperty;
import net.bhtech.lygmanager.net.cxfweservice.ksoap2.SoapEnvelope;
import net.bhtech.lygmanager.net.cxfweservice.ksoap2.serialization.MarshalBase64;
import net.bhtech.lygmanager.net.cxfweservice.ksoap2.serialization.SoapObject;
import net.bhtech.lygmanager.net.cxfweservice.ksoap2.serialization.SoapSerializationEnvelope;
